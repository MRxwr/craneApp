                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-12">
                                        <input type="text" class="form-control" placeholder="Site Title.." value="{{$user->title[$lang->code]}}" name="title[{{ $lang->code }}]">
                                    </div>
                                </div>
                                @endforeach
                                @foreach (getActiveLanguages()  as $lang)
                                ...
                                <div class="form-group row">
                                <div class="col-lg-3 col-12" style="height:250px;"><img src="{{ asset($user->image) }}" class="img-rounded" alt="Uploaded Image"></div>
                                    <div class="col-lg-9 col-12">
