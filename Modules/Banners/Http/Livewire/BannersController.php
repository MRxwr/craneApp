...
namespace Modules\Banners\Http\Livewire;
...
class BannersController extends Controller
{
    ...
    {
        return view('banners::livewire.banners.add');
    }
        ...
        $page = new Banner();
            ...
            if ($request->hasFile('image')) {
               ...
               // Save the file to the 'public' disk
                ...
                $page->image = 'storage/banners/'.$imageName;
            }
            $page->save();
    ...
    public function edit($id){
        ...
        return view('banners::livewire.banners.edit', compact('service'));
    }
