               ...
               $prices=[];
                foreach ($dt as $key=>$bookingRequest){
                    if($bookingRequest->status==1){
                         ...
                         $upcommingRequest[$key]['rating'] = $bookingRequest->status;
                    }
                    if($bookingRequest->status==2){
                        ...
                        $arrivedRequest[$key]['rating'] = $bookingRequest->status;
                   }
                    if($bookingRequest->status==3){
                        ...
                        $ongoingRequest[$key]['rating'] = $bookingRequest->status;
                   }
                   if($bookingRequest->status==4){
                        ...
                        $canceledRequest[$key]['rating'] = $bookingRequest->status;
                    }
                    if($bookingRequest->status==5){
                        ...
                        $completedRequest[$key]['rating'] = $bookingRequest->status;
                   }
