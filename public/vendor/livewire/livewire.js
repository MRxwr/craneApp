!(function (global, factory) {
   "object" == typeof exports && "undefined" != typeof module
       ...
       ? define(factory)
       : ((global = "undefined" != typeof globalThis ? globalThis : global || self).Livewire = factory());
})(this, function () {
   "use strict";
   ...
   function _defineProperty(obj, key, value) {
       return (key = _toPropertyKey(key)) in obj ? Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }) : (obj[key] = value), obj;
   }
                       ...
                       value: function (defaultDuration) {
                           ...
                           return (
                               durationInMilliSecondsString
                                   ...
                                   : durationInSecondsString && (durationInMilliSeconds = 1e3 * Number(durationInSecondsString.replace("s", ""))),
   ...
   var _default$6 = (function () {
       ...
       _default$5 = (function (_Action) {
           ...
           function _default(event, params, el) {
               var _this;
               return _classCallCheck(this, _default), ((_this = _super.call(this, el)).type = "fireEvent"), (_this.payload = { id: _this.signature, event: event, params: params }), _this;
           }
           return (
               _createClass(_default, [
                   {
   ...
   v8 && ((match = v8.split(".")), (version = match[0] > 0 && match[0] < 4 ? 1 : +(match[0] + match[1]))),
       !version && engineUserAgent && ((match = engineUserAgent.match(/Edge\/(\d+)/)), (!match || match[1] >= 74) && ((match = engineUserAgent.match(/Chrome\/(\d+)/)), match && (version = +match[1])));
       ...
       wellKnownSymbol = function (name) {
           if (!hasOwnProperty_1(WellKnownSymbolsStore, name) || (!symbolConstructorDetection && "string" != typeof WellKnownSymbolsStore[name])) {
               ...
               symbolConstructorDetection && hasOwnProperty_1(Symbol$1, name)
                   ...
                   : (WellKnownSymbolsStore[name] = useSymbolAsUid && symbolFor ? symbolFor(description) : createWellKnownSymbol(description));
           }
   ...
   var toStringTagSupport = "[object z]" === String(test),
       ...
       classof = toStringTagSupport
           ...
           : function (it) {
                 ...
                 return void 0 === it
                     ...
                     : null === it
                     ? "Null"
                     : "string" == typeof (tag = tryGet((O = $Object$3(it)), TO_STRING_TAG$3))
                     ? tag
                     : CORRECT_ARGUMENTS
                     ? classofRaw(O)
           ...
           return function ($this, pos) {
               ...
               return position < 0 || position >= size
                   ? CONVERT_TO_STRING
                       ? ""
                       : void 0
                   : (first = charCodeAt(S, position)) < 55296 || first > 56319 || position + 1 === size || (second = charCodeAt(S, position + 1)) < 56320 || second > 57343
                   ? CONVERT_TO_STRING
                       ? charAt$1(S, position)
                       : first
                   : CONVERT_TO_STRING
       ...
       f$6 = descriptors
           ? v8PrototypeDefineBug
               ...
               : $defineProperty
           : function (O, P, Attributes) {
                 if ((anObject(O), (P = toPropertyKey(P)), anObject(Attributes), ie8DomDefine))
                     try {
                         return $defineProperty(O, P, Attributes);
                     } catch (error) {}
   ...
   var inspectSource = sharedStore.inspectSource,
           ...
           var CONFIGURABLE_FUNCTION_NAME = functionName.CONFIGURABLE,
               ...
               makeBuiltIn = (module.exports = function (value, name, options) {
                   "Symbol(" === String(name).slice(0, 7) && (name = "[" + String(name).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
                       ...
                       (!hasOwnProperty_1(value, "name") || (CONFIGURABLE_FUNCTION_NAME && value.name !== name)) && (descriptors ? defineProperty(value, "name", { value: name, configurable: !0 }) : (value.name = name)),
                       CONFIGURABLE_LENGTH && options && hasOwnProperty_1(options, "arity") && value.length !== options.arity && defineProperty(value, "length", { value: options.arity });
                   try {
       ...
       defineBuiltIn = function (O, key, value, options) {
           ...
           if ((isCallable(value) && makeBuiltIn_1(value, name, options), options.global)) simple ? (O[key] = value) : defineGlobalProperty(key, value);
               ...
               simple ? (O[key] = value) : objectDefineProperty.f(O, key, { value: value, enumerable: !1, configurable: !options.nonConfigurable, writable: !options.nonWritable });
           }
           return O;
       },
       max = Math.max,
   ...
   var objectCreate =
           ...
           function (O, Properties) {
               var result;
               return (
                   null !== O ? ((EmptyConstructor[PROTOTYPE] = anObject(O)), (result = new EmptyConstructor()), (EmptyConstructor[PROTOTYPE] = null), (result[IE_PROTO$1] = O)) : (result = NullProtoObject()),
   ...
   [].keys &&
       ...
       "next" in arrayIterator
           ? ((PrototypeOfArrayIteratorPrototype = objectGetPrototypeOf(objectGetPrototypeOf(arrayIterator))), PrototypeOfArrayIteratorPrototype !== Object.prototype && (IteratorPrototype$2 = PrototypeOfArrayIteratorPrototype))
   ...
   var iteratorsCore = { IteratorPrototype: IteratorPrototype$2, BUGGY_SAFARI_ITERATORS: BUGGY_SAFARI_ITERATORS$1 },
       ...
       setToStringTag = function (target, TAG, STATIC) {
           target && !STATIC && (target = target.prototype), target && !hasOwnProperty_1(target, TO_STRING_TAG$2) && defineProperty$3(target, TO_STRING_TAG$2, { configurable: !0, value: TAG });
       },
       iterators = {},
       ...
       iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
           ...
           if (
               (anyNativeIterator &&
                   (CurrentIteratorPrototype = objectGetPrototypeOf(anyNativeIterator.call(new Iterable()))) !== Object.prototype &&
                   CurrentIteratorPrototype.next &&
                   (objectGetPrototypeOf(CurrentIteratorPrototype) !== IteratorPrototype &&
                       (objectSetPrototypeOf ? objectSetPrototypeOf(CurrentIteratorPrototype, IteratorPrototype) : isCallable(CurrentIteratorPrototype[ITERATOR$4]) || defineBuiltIn(CurrentIteratorPrototype, ITERATOR$4, returnThis)),
   ...
   var isConstructor =
       ...
       arrayFrom = function (arrayLike) {
           ...
           if (!iteratorMethod || (this === $Array$1 && isArrayIteratorMethod(iteratorMethod)))
               ...
               for (next = (iterator = getIterator(O, iteratorMethod)).next, result = IS_CONSTRUCTOR ? new this() : []; !(step = functionCall(next, iterator)).done; index++)
   ...
   null == ArrayPrototype[UNSCOPABLES] && defineProperty$2(ArrayPrototype, UNSCOPABLES, { configurable: !0, value: objectCreate(null) });
           ...
           for (var element, elementLen, targetIndex = start, sourceIndex = 0, mapFn = !!mapper && functionBindContext(mapper, thisArg); sourceIndex < sourceLen; )
               sourceIndex in source &&
                   ...
                   depth > 0 && isArray(element)
                       ? ((elementLen = lengthOfArrayLike(element)), (targetIndex = flattenIntoArray(target, original, element, elementLen, targetIndex, depth - 1) - 1))
               ...
               ? function (target, source) {
                     for (var T = toObject(target), argumentsLength = arguments.length, index = 1, getOwnPropertySymbols = objectGetOwnPropertySymbols.f, propertyIsEnumerable = objectPropertyIsEnumerable.f; argumentsLength > index; )
                         for (var key, S = indexedObject(arguments[index++]), keys = getOwnPropertySymbols ? concat(objectKeys(S), getOwnPropertySymbols(S)) : objectKeys(S), length = keys.length, j = 0; length > j; )
                             (key = keys[j++]), (descriptors && !functionCall(propertyIsEnumerable, S, key)) || (T[key] = S[key]);
                     return T;
                 }
               : $assign;
   _export({ target: "Object", stat: !0, arity: 2, forced: Object.assign !== objectAssign }, { assign: objectAssign }), path.Object.assign;
       ...
       createMethod = function (TO_ENTRIES) {
           return function (it) {
               for (var key, O = toIndexedObject(it), keys = objectKeys(O), length = keys.length, i = 0, result = []; length > i; )
                   (key = keys[i++]), (descriptors && !propertyIsEnumerable(O, key)) || push$1(result, TO_ENTRIES ? [key, O[key]] : O[key]);
               return result;
           };
       },
   ...
   var $Error$1 = Error,
       ...
       $AggregateError = function (errors, message) {
           ...
           objectSetPrototypeOf
               ...
               : ((that = isInstance ? this : objectCreate(AggregateErrorPrototype)), createNonEnumerableProperty(that, TO_STRING_TAG$1, "Error")),
   ...
   if ((addToUnscopables("keys"), addToUnscopables("values"), addToUnscopables("entries"), descriptors && "values" !== values.name))
       try {
   ...
   (set && clear) ||
       ...
       engineIsNode
           ...
           ? ((channel = new MessageChannel()), (port = channel.port2), (channel.port1.onmessage = listener), (defer = functionBindContext(port.postMessage, port)))
           : global_1.addEventListener && isCallable(global_1.postMessage) && !global_1.importScripts && $location && "file:" !== $location.protocol && !fails(post)
   ...
   var SPECIES = wellKnownSymbol("species"),
       ...
       promiseConstructorDetection = { CONSTRUCTOR: FORCED_PROMISE_CONSTRUCTOR$5, REJECTION_EVENT: NATIVE_PROMISE_REJECTION_EVENT$1, SUBCLASSING: SUBCLASSING },
       ...
       callReaction = function (reaction, state) {
           ...
           try {
               handler
                   ? (ok || (state.rejection === UNHANDLED && onHandleUnhandled(state), (state.rejection = HANDLED)),
                     !0 === handler ? (result = value) : (domain && domain.enter(), (result = handler(value)), domain && (domain.exit(), (exited = !0))),
                     result === reaction.promise ? reject(TypeError$1("Promise-chain cycle")) : (then = isThenable(result)) ? functionCall(then, result, resolve, reject) : resolve(result))
                   : reject(value);
           } catch (error) {
       ...
       dispatchEvent = function (name, promise, reason) {
           var event, handler;
           DISPATCH_EVENT ? (((event = document$1.createEvent("Event")).promise = promise), (event.reason = reason), event.initEvent(name, !1, !0), global_1.dispatchEvent(event)) : (event = { promise: promise, reason: reason }),
   ...
   if (
       ...
       (Internal = function (executor) {
           setInternalState(this, { type: PROMISE, done: !1, notified: !1, parent: !1, reactions: new queue(), rejection: !1, state: PENDING, value: void 0 });
       }),
   ...
   _export({ global: !0, constructor: !0, wrap: !0, forced: FORCED_PROMISE_CONSTRUCTOR$4 }, { Promise: PromiseConstructor }), setToStringTag(PromiseConstructor, PROMISE, !1), setSpecies(PROMISE);
                           ...
                           iterate(iterable, function (promise) {
                               ...
                               remaining++,
                                   functionCall(promiseResolve, C, promise).then(
                                       function (value) {
                                           alreadyCalled || ((alreadyCalled = !0), (values[index] = { status: "fulfilled", value: value }), --remaining || resolve(values));
                                       },
                                       function (error) {
                                           alreadyCalled || ((alreadyCalled = !0), (values[index] = { status: "rejected", reason: error }), --remaining || resolve(values));
                                       }
                                   );
                           }),
                               --remaining || resolve(values);
               ...
               (this.bodyUsed = this.bodyUsed),
                   ...
                   this.headers.get("content-type") ||
                       ("string" == typeof body
                           ...
                           : support.searchParams && URLSearchParams.prototype.isPrototypeOf(body) && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"));
           }),
           support.blob &&
               ((this.blob = function () {
           ...
           (xhr.onload = function () {
               ...
               "responseType" in xhr &&
                   (support.blob
                       ...
                       : support.arrayBuffer && request.headers.get("Content-Type") && -1 !== request.headers.get("Content-Type").indexOf("application/octet-stream") && (xhr.responseType = "arraybuffer")),
   ...
   (fetch$1.polyfill = !0),
       global$1.fetch || ((global$1.fetch = fetch$1), (global$1.Headers = Headers), (global$1.Request = Request), (global$1.Response = Response)),
   ...
   var Connection = (function () {
                       ...
                       value: function (message) {
                           ...
                           fetch("".concat(appUrl, "/livewire/message/").concat(payload.fingerprint.name), {
                               ...
                               headers: _objectSpread2(
                                   _objectSpread2(
                                       _objectSpread2({ "Content-Type": "application/json", Accept: "text/html, application/xhtml+xml", "X-Livewire": !0 }, this.headers),
                                       {},
       ...
       _default$4 = (function (_Action) {
           ...
           function _default(method, params, el) {
               ...
               return _classCallCheck(this, _default), ((_this = _super.call(this, el, skipWatcher)).type = "callMethod"), (_this.method = method), (_this.payload = { id: _this.signature, method: method, params: params }), _this;
           }
       ...
       return setInterval(function () {
           if (!1 !== node.isConnected) {
               ...
               if (!directives.missing("poll")) {
                   ...
                   (store$2.livewireIsInBackground && !directive.modifiers.includes("keep-alive") && Math.random() < 0.95) ||
               ...
               (attrName = (attr = attrs[i]).name),
                   ...
                   attrNamespaceURI
                       ? ((attrName = attr.localName || attrName),
                         fromNode.getAttributeNS(attrNamespaceURI, attrName) !== attrValue && ("xmlns" === attr.prefix && (attrName = attr.name), fromNode.setAttributeNS(attrNamespaceURI, attrName, attrValue)))
                       : fromNode.getAttribute(attrName) !== attrValue && fromNode.setAttribute(attrName, attrValue);
           for (i = (attrs = fromNode.attributes).length - 1; i >= 0; --i)
               !1 !== (attr = attrs[i]).specified &&
                   ((attrName = attr.name),
                   (attrNamespaceURI = attr.namespaceURI)
                       ? ((attrName = attr.localName || attrName), toNode.hasAttributeNS(attrNamespaceURI, attrName) || fromNode.removeAttributeNS(attrNamespaceURI, attrName))
               ...
               if (parentNode) {
                   ...
                   "OPTGROUP" === parentName && (parentName = (parentNode = parentNode.parentNode) && parentNode.nodeName.toUpperCase()),
                       "SELECT" !== parentName ||
                           ...
                           (fromEl.hasAttribute("selected") && !toEl.selected && (fromEl.setAttribute("selected", "selected"), fromEl.removeAttribute("selected")), (parentNode.selectedIndex = -1));
               }
   ...
   function morphdomFactory(morphAttrs) {
       return function (fromNode, toNode, options) {
           ...
           function walkDiscardedChildNodes(node, skipKeyedNodes) {
               if (node.nodeType === ELEMENT_NODE)
                   for (var curChild = node.firstChild; curChild; ) {
                       var key = void 0;
                       skipKeyedNodes && (key = callHook(getNodeKey, curChild)) ? addKeyedRemoval(key) : (callHook(onNodeDiscarded, curChild), curChild.firstChild && walkDiscardedChildNodes(curChild, skipKeyedNodes)),
                                     ...
                                     (curFromNodeType === curToNodeChild.nodeType &&
                                         (curFromNodeType === ELEMENT_NODE
                                             ? (curToNodeKey
                                               ...
                                               (isCompatible = !1 !== isCompatible && compareNodeNames(curFromNodeChild, curToNodeChild)) &&
                                                   (!curToNodeChild.isEqualNode(curFromNodeChild) && curToNodeChild.nextElementSibling && curToNodeChild.nextElementSibling.isEqualNode(curFromNodeChild)
                                                       ? (isCompatible = !1)
                                                       : morphEl(curFromNodeChild, curToNodeChild)))
                                             : (curFromNodeType !== TEXT_NODE && curFromNodeType != COMMENT_NODE) ||
                                               ((isCompatible = !0), curFromNodeChild.nodeValue !== curToNodeChild.nodeValue && (curFromNodeChild.nodeValue = curToNodeChild.nodeValue))),
                                     isCompatible)
                                 ) {
                                     (curToNodeChild = toNextSibling), (curFromNodeChild = fromNextSibling);
                                     continue outer;
           ...
           if (!childrenOnly)
               if (morphedNodeType === ELEMENT_NODE)
                   toNodeType === ELEMENT_NODE
                       ? compareNodeNames(fromNode, toNode) || (callHook(onNodeDiscarded, fromNode), (morphedNode = moveChildren(fromNode, createElementNS(toNode.nodeName, toNode.namespaceURI))))
                       : (morphedNode = toNode);
           ...
           return (
               !childrenOnly && morphedNode !== fromNode && fromNode.parentNode && (morphedNode.actualize && (morphedNode = morphedNode.actualize(fromNode.ownerDocument || doc)), fromNode.parentNode.replaceChild(morphedNode, fromNode)),
               morphedNode
           );
       };
   }
   var morphdom = morphdomFactory(morphAttrs),
       _default$1 = (function (_Action) {
           ...
           function _default(name, value, el) {
               var _this;
               return _classCallCheck(this, _default), ((_this = _super.call(this, el)).type = "syncInput"), (_this.name = name), (_this.payload = { id: _this.signature, name: name, value: value }), _this;
           }
           return _createClass(_default);
       })(_default$6),
       _default = (function (_Action) {
           ...
           function _default(name, value, el) {
               var _this,
                   skipWatcher = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
               return _classCallCheck(this, _default), ((_this = _super.call(this, el, skipWatcher)).type = "syncInput"), (_this.name = name), (_this.payload = { id: _this.signature, name: name, value: value }), _this;
           }
           return _createClass(_default);
       })(_default$6),
       nodeInitializer = {
                       ...
                       handler =
                           ...
                           (callback = function (e) {
                               var _e$detail,
                                   ...
                                   el = e.target,
                                   value =
                                       e instanceof CustomEvent && void 0 !== e.detail && void 0 === window.document.documentMode
                       ...
                       function (e) {
                           (callback && !1 === callback(e)) ||
                               component.callAfterModelDebounce(function () {
                                   ...
                                   if ((0 === params.length && e instanceof CustomEvent && e.detail && params.push(e.detail), "$emit" === method))
                                       return (_component$scopedList = component.scopedListeners).call.apply(_component$scopedList, _toConsumableArray(params)), void store$2.emit.apply(store$2, _toConsumableArray(params));
                                   "$emitUp" !== method
                                       ? "$emitSelf" !== method
                                           ? "$emitTo" !== method
                                               ? directive.value && component.addAction(new _default$4(method, params, el))
                                               : store$2.emitTo.apply(store$2, _toConsumableArray(params))
                                           : store$2.emitSelf.apply(store$2, [component.id].concat(_toConsumableArray(params)))
                                       : store$2.emitUp.apply(store$2, [el].concat(_toConsumableArray(params)));
                               });
                       },
       ...
       actionsNames
           ? actionsNames.forEach(function (actionsName) {
                 component.targetedLoadingElsByAction[actionsName]
                     ? component.targetedLoadingElsByAction[actionsName].push({ el: el, directive: directive })
               ...
               _createClass(UploadManager, [
                   ...
                   },
                   {
                       ...
                       value: function (name, file, finishCallback, errorCallback, progressCallback) {
                           this.setUpload(name, { files: [file], multiple: !1, finishCallback: finishCallback, errorCallback: errorCallback, progressCallback: progressCallback });
                       },
                   },
                   {
                       key: "uploadMultiple",
                       value: function (name, files, finishCallback, errorCallback, progressCallback) {
                           this.setUpload(name, { files: Array.from(files), multiple: !0, finishCallback: finishCallback, errorCallback: errorCallback, progressCallback: progressCallback });
                       },
                   },
                   {
                       key: "removeUpload",
                       value: function (name, tmpFilename, finishCallback) {
                           this.removeBag.push(name, { tmpFilename: tmpFilename, finishCallback: finishCallback }), this.component.call("removeUpload", name, tmpFilename);
                       },
                   },
                   {
                       key: "setUpload",
                           ...
                           if (value && "object" === _typeof(value) && value.livewireEntangle) {
                               ...
                               component.unobservedData.$watch(key, function (value) {
                                   !0 !== blockAlpineWatcher
                                       ? JSON.stringify(value) != JSON.stringify(livewireEl.__livewire.getPropertyValueIncludingDefers(livewireProperty)) && livewireComponent.set(livewireProperty, value, isDeferred, !isDeferred)
                               ...
                               ? Object.entries(value || {}).forEach(function (_ref3) {
                                     ...
                                     (_this3.serverMemo.data[dataKey] = dataValue),
                                         message.shouldSkipWatcherForDataKey(dataKey) ||
                                             Object.entries(_this3.watchers).forEach(function (_ref5) {
               ...
               },
               {
                   ...
                   value: function (message) {
                       ...
                       this.updateServerMemoFromResponseAndMergeBackIntoResponse(message),
                           ...
                           response.effects.html ? ((this.lastFreshHtml = response.effects.html), this.handleMorph(response.effects.html.trim())) : this.handleMorph(this.lastFreshHtml),
                               ...
                               response.effects.emits &&
                                   ...
                                   response.effects.emits.forEach(function (event) {
                                       ...
                                       (_this6$scopedListener = _this6.scopedListeners).call.apply(_this6$scopedListener, [event.event].concat(_toConsumableArray(event.params))),
                                           event.selfOnly
                                               ? store$2.emitSelf.apply(store$2, [_this6.id, event.event].concat(_toConsumableArray(event.params)))
                                               : event.to
                                               ? store$2.emitTo.apply(store$2, [event.to, event.event].concat(_toConsumableArray(event.params)))
                                               : event.ancestorsOnly
                                               ? store$2.emitUp.apply(store$2, [_this6.el, event.event].concat(_toConsumableArray(event.params)))
                                               : store$2.emit.apply(store$2, [event.event].concat(_toConsumableArray(event.params)));
                                   }),
                                       ...
                                       if ("string" == typeof property && property.match(/^emit.*/))
                                           return function () {
                                               ...
                                               return "emitSelf" === property
                                                   ? store$2.emitSelf.apply(store$2, [component.id].concat(args))
                                                   : "emitUp" === property
                                                   ? store$2.emitUp.apply(store$2, [component.el].concat(args))
   ...
   function FileUploads() {
      ...
      //                      (el.dispatchEvent(new CustomEvent("livewire-upload-start", { bubbles: !0 })),
           ...
           store$2.registerHook("interceptWireModelAttachListener", function (directive, el, component) {
               ...
               el.addEventListener("input", function () {
                   component.dirtyEls.forEach(function (dirtyEl) {
                       ...
                       ((directives.has("model") && directives.get("model").value === property) ||
                           (directives.has("target") &&
                               directives
                                   ...
                                   .includes(property))) &&
                           setDirtyState(dirtyEl, DOM.valueFromInput(el, component) != component.get(property));
                   });
               });
           }),
           store$2.registerHook("message.received", function (message, component) {
                       ...
                       component.walk(function (node) {
                           if (el.contains(node))
                               return (
                                   ...
                                   void (("button" === node.tagName.toLowerCase() && "submit" === node.type) ||
                                   "select" === node.tagName.toLowerCase() ||
                                   ("input" === node.tagName.toLowerCase() && ("checkbox" === node.type || "radio" === node.type))
                                       ? (node.disabled ||
                                             cleanupStackByComponentId[component.id].push(function () {
                                                 return (node.disabled = !1);
                                             }),
                                         (node.disabled = !0))
                                       : ("input" !== node.tagName.toLowerCase() && "textarea" !== node.tagName.toLowerCase()) ||
                                         (node.readOnly ||
                                             cleanupStackByComponentId[component.id].push(function () {
               ...
               _createClass(LivewireState, [
                   ...
                   },
                   {
                       ...
                       value: function (signature) {
                           ...
                           return { originalComponentId: _signature$split2[0], componentName: _signature$split2[1], componentIndex: _signature$split2[2] };
                       },
                   },
                   {
